...
public class SlotMachine1 extends javax.swing.JFrame
{
    ...
    {//GEN-HEADEREND:event_jButton1ActionPerformed
        ...
        ImageIcon[] pic1 = new ImageIcon[26];
        
        Random rand1 = new Random();
        
        int randNum1 = rand1.nextInt(27);
        ...
        for(int i=0; i< pic1.length;i++)
        {
            //pic1[i] =getImage(getDocumentBase(),"aa" + (i +1) + ".png");
             ...
             ImageIcon pic = new ImageIcon("aa"+(i+1)+".png");
          ...
          JLabel4 = new JLabel("Images/aa2.png");
            add (JLabel4);
        ...
        //Image[] pic2 = new Image[26];
        //Image[] pic1 = new Image[26];
        //Image[] pic1 = new Image[26];
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new SlotMachine1().setVisible(true);
            }
        });
    }
