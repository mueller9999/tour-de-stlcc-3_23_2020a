...
public class GuessingGameView extends FrameView {
   ...
   // GuessingBothGames gBoth;
    Game game1; //instance of interface
    ...
    private void initComponents()
    {
        ...
        jmnuHiLo.addItemListener(new java.awt.event.ItemListener()
        {
            public void itemStateChanged(java.awt.event.ItemEvent evt)
            {
                jmnuHiLoItemStateChanged(evt);
            }
        });
    ...
    private void jbtnSubmitGuessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnSubmitGuessActionPerformed
            ...
            game1.setGuess(jtxtGuess.getText());
                
   
            if (!(game1.getErrorMsg().isEmpty()))
            {
                statusMessageLabel.setText(game1.getErrorMsg());
            }
            else if (game1.isOver()) 
            {
            ...
            {
                jtxtGuessHistory.append(game1.getGuessResult());
            }
            jtxtGuess.setText("");
    ...
    private void jmnuHiLoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmnuHiLoActionPerformed
        ...
        jtxtGameName.setText(game1.getGameName());
        jtxtInstructions.setText(game1.getInstructions());
    ...
    private void jmnuHiLoItemStateChanged(java.awt.event.ItemEvent evt)//GEN-FIRST:event_jmnuHiLoItemStateChanged
    {//GEN-HEADEREND:event_jmnuHiLoItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_jmnuHiLoItemStateChanged
